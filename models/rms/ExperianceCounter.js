...
const ExperianceCounterSchema = new Schema({
    year: { 
        type: Number, 
        required: true,
        unique: true 
...
ExperianceCounterSchema.statics.getNextReference = async function() {
    ...
    return `ZB/HC/EXP/${paddedCount}/${twoDigitYear}`;
};

const ExperianceCounter = mongoose.model('ExperianceCounter', ExperianceCounterSchema);
